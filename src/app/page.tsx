                ...
                <Card className="w-full max-w-md mx-auto">
                  ...
                  <CardContent className="space-y-4">
                    <Button variant="outline" className="w-full py-6 text-base font-medium" asChild>
                      {/* remember to change the localhost to current origin */}
                      <a href="https://github.com/login/oauth/authorize?client_id=Ov23li0zclDZ7XsACEGa&redirect_uri=http://localhost:3000/api/auth/github&scope=repo" className="flex items-center justify-center">
